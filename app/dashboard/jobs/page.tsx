    ...
    return (
      <div className="min-h-screen bg-[#15181D] p-8">
        <div className="mx-auto max-w-2xl">
          <p className="text-sm text-[#8B92A0]">This page is only available to the master account.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#15181D] p-8">
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-wide text-[#EDEEF0]">All Jobs</h1>
                ...
                <tbody>
                  {jobs.map((job: any) => (
                    <tr key={job.id} className="border-b border-[#2C313A] text-[#EDEEF0] last:border-b-0">
                      <td className="px-3 py-3">{job.organisations?.name ?? "—"}</td>
