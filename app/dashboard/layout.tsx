  ...
  return (
    <div className="flex min-h-screen">
      <nav className="w-56 border-r bg-gray-50 p-4 space-y-1 flex-shrink-0">
        ...
        <div className="text-xs text-gray-400 uppercase tracking-wide mt-4 mb-1">Admin</div>
        <Link href="/dashboard/settings" className="block text-sm py-1.5 px-2 rounded hover:bg-gray-200">Settings</Link>
